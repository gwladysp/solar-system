...
import {FETCH_ALL_API_URL, FETCH_API_URL} from "../constants";
    ...
    <>
          <div className="flex justify-between max-w-screen-xl mx-auto items-center my-16 text-lg">
            <div className="max-w-md">
              ...
              <div>
                <a className="p-4 border-b-1 border-white flex items-center" href="#solarSystem">
                  <img className="h-6 w-6 mr-8 rounded-full object-cover" src="/images/sun.svg" alt="Sun" />
                  View in the solar system
                </a>
                <a className="p-4 border-b-1 border-white flex items-center" href="#moreStatistics">
                  <img className="h-6 w-6 mr-8 text-white" src="/images/chart.svg" alt="Sun" />
                  More stats
                </a>
                <a className="p-4 border-1 border-white flex items-center" href="#moons">
          ...
          <div className="max-w-screen-xl mx-auto my-16">
            ...
            <div className="mx-16 pt-16" id="solarSystem">
              <h2 className="text-center">{planetNameFormatted} into our Solar System</h2>
            ...
            <div className="mx-16 pt-16" id="moreStatistics">
              ...
              <Graph planet={planet} allPlanets={allPlanets} dataSorting="gravity" dataUnity={"m/s"} />
            ...
            <div className="mt-16" id="moons">
              ...
              <div className="flex items-center my-16 mx-auto">
                <img className="planet-moons h-32 mr-12" src="/images/moon.svg" alt="Moon" />
                <div>
                  <p className="block">
                    {planetNameFormatted} owns {planet.moons ? planet.moons.length : 'no'} moons.
                  </p>
                  <p>
                    {planet.moons
                        ? '(' +
            ...
            <div className="flex max-w-md items-center mx-auto">
              {planet.discoveredBy
                ? '<p>' +
                  ...
                  '</p>'
                : ''}
              <img className="h-auto w-1/4 mx-auto" src="/images/telescop.svg" alt={planetName} />
            </div>
          </div>
        </>
  );
