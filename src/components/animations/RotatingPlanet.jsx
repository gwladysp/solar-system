import {PLANETS_WITH_RING} from "../../constants";
    ...
    <>
      <div className="rotating-planet-container">
              <div className="planet" style={{ backgroundImage: `url(${bgImage})` }}>
                  <div className="clouds" style={{ backgroundImage: `url(/images/clouds.svg)` }}/>
              </div>
          {hasRing ? <div className="planet-ring" style={{ borderColor: `${ringColor[planet.id]}` }}/> : ''}
      </div>
    </>
  );
}
