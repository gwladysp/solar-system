import {PLANETS_WITH_RING, SOLAR_SIZE_IN_EM, SOLAR_SIZE_IN_KM} from "../../../constants";
    ...
    <>
      ...
      >
        <div className="pos" style={{ animationDuration: `${speed}s` }}>
            ...
            />
            {hasRing ? <div className="planet-ring orbiting-ring"
                            style={{
          ...
          <p className="relative z-10" style={{ top: `-${planetSize / 2 + 1}vw` }}>
            {planet.englishName}
          </p>
        </div>
      </div>
