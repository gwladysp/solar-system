    ...
    return <>
        <div key={planet.id} className="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div className="flex-shrink-0">
                  <img className="h-48 w-2/3 object-cover object-center" src={'/images/' + planet.englishName + '.svg'} alt={planet.englishName} />
              </div>
              <div className="flex-1 bg-blue-light p-6 flex flex-col justify-between">
                <div className="flex-1">
                  ...
                  <div>
                    ...
                    {planet.englishName.charAt(0).toUpperCase() + planet.englishName.slice(1)}
                    </p>
                    <p className="mt-3 text-base text-gray-500">Short planet description of approximatly two or three lines giving basics informations about the planet</p>
                  </div>
                  ...
                  <Link to={`${match.url}/${planet.englishName.toLowerCase()}`} planet={props}>Discover</Link>
                    </button>
                </div>
                </div>
      </div>
