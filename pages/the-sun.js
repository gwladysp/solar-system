      ...
      {sunInfos.length !== 0 ? (
        <>
          ...
          <div>
            <p>
              Surface temperature :{" "}
              {sunInfos.avgTemp === 0 ? "5,778 K" : sunInfos.temperature}
            </p>
            {sunInfos.mass ? (
              <p>
                Mass : {sunInfos.mass.massValue}{" "}
                <sup>{sunInfos.mass.massExponent}</sup> kg
              </p>
            ) : (
              ""
            )}
            ...
            <p>
              Gravity : {sunInfos.gravity === 0 ? "274 m/s²" : sunInfos.gravity}
            </p>
          </div>
        </>
      ) : (
